...
>
  ...
  <a
    ...
    rel="noopener"
    target="_blank"
    class="order-2 w-full grid-flow-col items-center justify-end gap-2 text-gray-400 md:order-none md:place-self-center md:justify-self-end md:pr-4"
  >
    Created by
    <div class="rounded bg-gray-600 p-1"><img src="" /></div>
  </a>
</footer>
